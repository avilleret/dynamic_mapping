...
void main(){
	...
	float noiseAmntX = noise( vec2(-timeValX + pos.y + pos.x / 1000.0f, 100.0f), 20.0 );
	float noiseAmntY = noise( vec2(timeValY + pos.x / 1000.0f, pos.x / 2000.0f), 20.0 );

	//modify our position with the smooth noise
	pos.x += noiseAmntX * noiseamount;
	pos.y += noiseAmntY * noiseamount;
